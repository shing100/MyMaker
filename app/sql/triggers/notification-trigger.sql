...
BEGIN
    ...
    VALUES ('follow', NEW.follower_id, NEW.following_id, '새로운 팔로우가 있습니다.');
    RETURN NEW;
END;
$$;
...
BEGIN
    ...
    INSERT INTO public.notifications (type, source_id, target_id, message)
    VALUES ('review', NEW.profile_id, product_owner, '새 리뷰가 등록되었습니다.');
    RETURN NEW;
END;
$$;
...
BEGIN
    ...
    INSERT INTO public.notifications (type, source_id, target_id)
    VALUES ('reply', NEW.profile_id, post_owner, '새 댓글이 등록되었습니다.');
    RETURN NEW;
END;
$$;
